  ...
  const handleSubmit = async (e:React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        alert("メールアドレスを確認できなかったため, 新規登録を行ってください．");
              ...
              <VStack spacing={4}>
                <FormControl isRequired>
                  ...
                  <InputGroup>
                    ...
                    <Input id="email" type="email" placeholder="your@email.com" value={email} onChange={(e) => setEmail(e.target.value)} borderColor="gray.200" _focus={{ borderColor: 'brand.500' }} />
                  </InputGroup>
                </FormControl>
                <FormControl isRequired>
                  ...
                  <InputGroup>
                    ...
                    <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} borderColor="gray.200" _focus={{ borderColor: 'brand.500' }} />
                  </InputGroup>
                </FormControl>
