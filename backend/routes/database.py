...
((SELECT id FROM users WHERE email = 'takahashi.misaki@example.com'), '読書, 映画鑑賞, カフェ', '神奈川県', '金融', 'INFJ', '慶應義塾大学', 'hobbies, field', '映画や読書が趣味の高橋美咲です。カフェ巡りが好きで、ゆっくりとした時間を大切にしています。金融業界に興味があり、理想的な仲間を探しています。'),
...
((SELECT id FROM users WHERE email = 'tanaka.naoki@example.com'), 'プログラミング, 筋トレ, ゲーム', '北海道', '技統本', 'ENTP', '東京大学', 'hobbies, role', 'プログラミングが大好きで、筋トレも趣味です。ゲームを通じてリラックスするのが好きで、エンタープライズ系の技術職に興味があります。新しい技術に挑戦したいです。'),
((SELECT id FROM users WHERE email = 'nakamura.yumi@example.com'), '読書, カメラ, 映画鑑賞', '愛知県', '法人', 'INFP', '名古屋大学', 'field', '初めまして、ナカムラユミです。カメラと映画が趣味で、週末は写真を撮りながら散歩しています。法人分野に興味があり、ビジネスを学びたいと思っています。どうぞよろしくお願いします！'),
((SELECT id FROM users WHERE email = 'yamamoto.shota@example.com'), '音楽, ゲーム, キャンプ', '大阪府', '公共', 'ISTJ', '大阪大学', 'field, hobbies', '音楽やゲームが好きな山本翔太です。自然の中で過ごすことが好きで、キャンプもよく行きます。公共分野に関心があり、社会に貢献できる仕事を目指しています。'),
((SELECT id FROM users WHERE email = 'kobayashi.hitomi@example.com'), '映画鑑賞, ラーメン, スポーツ観戦', '京都府', '金融', 'ESFP', '立命館大学', 'hobbies', '映画とラーメンが大好きな小林仁美です。友達と映画を観ることが多いですが、スポーツ観戦も欠かせません。共通の趣味がある方とお友達になりたいです！'),
...
((SELECT id FROM users WHERE email = 'matsumoto.ayako@example.com'), 'カフェ, 読書, 音楽', '東京都', '金融', 'ISTP', '早稲田大学', 'hobbies', '松本綾子です。カフェでゆっくり過ごしながら読書を楽しんでいます。音楽も欠かせません。金融業界に興味があり、新しい挑戦に一緒に取り組める仲間を探しています。'),
((SELECT id FROM users WHERE email = 'ishii.keiko@example.com'), 'スポーツ観戦, 映画鑑賞, サッカー', '千葉県', 'TC&S', 'ENFJ', '明治大学', 'mbti, role', '石井佳子です！スポーツ観戦が好きで、特にサッカーに情熱を注いでいます。映画鑑賞も趣味で、ポジティブなエネルギーを持った方々と一緒に働きたいです。よろしくお願いします！'),
...
((SELECT id FROM users WHERE email = 'yoshida.miyuki@example.com'), '旅行, サッカー, カフェ', '神奈川県', '金融', 'ISFJ', '早稲田大学', 'hobbies, role', '吉田美由紀です！旅行とサッカーが大好きで、カフェ巡りも楽しんでいます。金融分野に関心があり、柔軟で協力的な方と一緒に働きたいです。'),
((SELECT id FROM users WHERE email = 'inoue.yuichi@example.com'), '映画鑑賞, 音楽, バスケットボール', '大阪府', '法人', 'ENFP', '大阪大学', 'field, alma_mater', '映画と音楽が大好きな井上雄一です。バスケットボールをしてリフレッシュするのが日課です。法人分野に挑戦したいと思っています！'),
((SELECT id FROM users WHERE email = 'hashimoto.mayumi@example.com'), '読書, ゲーム, 筋トレ', '兵庫県', 'TC&S', 'ISTJ', '京都大学', 'role', '橋本真由美です。読書とゲームが趣味で、筋トレにも力を入れています。私自身、技術的な問題解決を追求したいと思っています！'),
((SELECT id FROM users WHERE email = 'yamada.shunsuke@example.com'), 'ランニング, サッカー, 旅行', '福岡県', '法人', 'ESTP', '早稲田大学', 'hobbies', 'ランニングとサッカーが好きな山田俊輔です。旅行を通じて新しい場所を探索するのが楽しみです。人と関わることが好きなので、みんなで活動できる環境を探しています。'),
((SELECT id FROM users WHERE email = 'fujita.reina@example.com'), '映画鑑賞, カメラ, 料理', '千葉県', '金融', 'ISFP', '慶應義塾大学', 'mbti', '藤田玲奈です！映画鑑賞とカメラが趣味で、週末はよく料理も楽しんでいます。金融分野でのキャリアを築きたいと思っています。新しい出会いを楽しみにしています！'),
((SELECT id FROM users WHERE email = 'matsuda.yusuke@example.com'), '旅行, 音楽, スポーツ観戦', '東京都', '公共', 'ENTJ', '東京大学', 'hobbies', '松田悠介です。旅行や音楽が大好きで、スポーツ観戦も欠かせません。社会貢献に興味があり、公共の分野で活動する仲間を探しています。'),
((SELECT id FROM users WHERE email = 'kuroda.yuka@example.com'), 'ダンス, 映画鑑賞, キャンプ', '愛知県', '技統本', 'ENFJ', '名古屋大学', 'role, alma_mater', 'こんにちは、黒田由香です！ダンスと映画鑑賞が好きで、キャンプにも行くことが多いです。技術的な分野に興味があり、成長できる環境で活躍したいと思っています。'),
((SELECT id FROM users WHERE email = 'komatsu.minako@example.com'), 'バスケットボール, 旅行, 音楽', '大阪府', '金融', 'ISFJ', '立命館大学', 'field', '小松美奈子です！バスケットボールが趣味で、旅行にもよく出かけます。音楽が生活の一部で、金融業界でキャリアを築いていきたいと思っています。'),
((SELECT id FROM users WHERE email = 'miura.masahiro@example.com'), 'カメラ, 料理, 音楽', '北海道', '法人', 'ISTP', '北海道大学', 'field, alma_mater, role', '三浦正博です。カメラと料理が好きで、音楽も大切にしています。法人でのビジネス展開に興味があり、新しい経験を得たいと考えています。'),
...
((SELECT id FROM users WHERE email = 'endo.aiko@example.com'), '読書, 映画鑑賞, サッカー', '大阪府', '法人', 'INFJ', '京都大学', 'hobbies, mbti', '遠藤愛子です。読書や映画鑑賞が大好きで、サッカーを観ることも趣味です。静かな時間を大切にしており、論理的な会話ができる方とお話ししたいと思っています。'),
((SELECT id FROM users WHERE email = 'ono.yoshiki@example.com'), '音楽, 旅行, プログラミング', '福岡県', '技統本', 'ISFP', '東京大学', 'hobbies', '小野芳樹です！音楽とプログラミングが好きで、旅行も大好きです。新しい技術や方法論を学び、他の技術者と協力できる環境を求めています。'),
((SELECT id FROM users WHERE email = 'nishimura.masahiko@example.com'), '映画鑑賞, ダンス, バスケットボール', '東京都', '公共', 'ESTJ', '慶應義塾大学', 'hobbies', '西村雅彦です！映画鑑賞とダンスが趣味で、バスケットボールも楽しんでいます。公共の分野での成長に興味があり、責任感のあるポジションを求めています。'),
((SELECT id FROM users WHERE email = 'takada.mizuki@example.com'), 'カメラ, 旅行, 筋トレ', '京都府', '法人', 'ISTP', '大阪大学', 'field, role', '高田美月です！カメラと旅行が趣味で、筋トレをして体を鍛えています。法人分野で成長し、戦略的な考え方を活かした仕事ができれば嬉しいです！'),
((SELECT id FROM users WHERE email = 'iwasaki.shinji@example.com'), 'サッカー, 音楽, 読書', '北海道', '金融', 'INTJ', '北海道大学', 'mbti', '岩崎真治です。サッカーと音楽が趣味で、読書も欠かせません。論理的な思考を重視し、金融の分野で成長したいと思っています。'),
((SELECT id FROM users WHERE email = 'murakami.kanako@example.com'), '旅行, カフェ, ボードゲーム', '神奈川県', '法人', 'ISFJ', '明治大学', 'role', '村上加奈子です！旅行とカフェ巡りが好きで、友達とボードゲームをするのが楽しみです。法人でのキャリアを積んで、人とのつながりを大切にしたいです。'),
((SELECT id FROM users WHERE email = 'harada.yui@example.com'), '料理, 音楽, 旅行', '千葉県', '金融', 'ENFJ', '立命館大学', 'mbti, role', '原田結衣です！料理と音楽が好きで、旅行もよく行きます。人とのつながりを大切にし、金融業界で積極的に成長していきたいです。'),
((SELECT id FROM users WHERE email = 'kimura.nagisa@example.com'), 'サッカー, 映画鑑賞, バスケットボール', '茨城県', '技統本', 'ESTJ', '早稲田大学', 'hobbies', '木村渚です！サッカーとバスケットボールが好きで、映画鑑賞も楽しんでいます。技術的な分野で、チームワークを活かして成果を出していきたいと思っています。'),
((SELECT id FROM users WHERE email = 'fujiwara.rie@example.com'), 'ボードゲーム, 旅行, カメラ', '大阪府', '法人', 'INFP', '関西大学', 'role', '藤原理恵です！ボードゲームが大好きで、旅行に出かけることが趣味です。法人の分野で、クリエイティブなアイディアを形にしていきたいです。'),
...
((SELECT id FROM users WHERE email = 'morimoto.makoto@example.com'), 'プログラミング, 音楽, バスケットボール', '大阪府', '金融', 'ENTP', '京都大学', 'field', '森本誠です！プログラミングと音楽が好きで、バスケットボールも楽しんでいます。金融分野に興味があり、データ分析や戦略的思考に挑戦したいです。'),
((SELECT id FROM users WHERE email = 'saito.satoshi@example.com'), '映画鑑賞, ラーメン, 読書', '北海道', '技統本', 'INTJ', '北海道大学', 'hobbies, role', '斉藤聡です！映画鑑賞とラーメンが趣味で、読書も大好きです。技術の分野で専門性を高め、新しい挑戦に取り組みたいと考えています。'),
((SELECT id FROM users WHERE email = 'fujii.tomoko@example.com'), '旅行, 音楽, 料理', '神奈川県', '法人', 'ISFJ', '明治大学', 'role', '藤井朋子です！旅行と音楽が趣味で、料理も楽しんでいます。法人分野でのキャリアを築きたいと思っており、責任ある役割を果たしたいです。'),
((SELECT id FROM users WHERE email = 'takahashi.naoto@example.com'), 'スポーツ観戦, バスケットボール, 料理', '東京都', '公共', 'ENFP', '慶應義塾大学', 'hobbies', '高橋直人です！スポーツ観戦とバスケットボールが好きで、料理も得意です。公共分野に関心があり、社会的な問題を解決したいと思っています。'),
((SELECT id FROM users WHERE email = 'hasegawa.kenna@example.com'), 'カフェ, 音楽, 旅行', '大阪府', '金融', 'ENFJ', '大阪大学', 'hobbies', '長谷川佳奈です！カフェ巡りや音楽が大好きで、旅行も楽しんでいます。金融業界で働き、柔軟でリーダーシップを持つ環境で成長したいです。'),
((SELECT id FROM users WHERE email = 'yoshimura.ryo@example.com'), '音楽, バスケットボール, ゲーム', '愛知県', '技統本', 'ISTP', '名古屋大学', 'field, mbti', '吉村亮です！音楽とバスケットボールが好きで、ゲームも趣味です。技術分野に興味があり、問題解決能力を高めたいと思っています。'),
((SELECT id FROM users WHERE email = 'nakagawa.sayo@example.com'), '映画鑑賞, ダンス, 料理', '京都府', '金融', 'ISFP', '立命館大学', 'role', '中川佐代です！映画鑑賞やダンスが趣味で、料理も大好きです。金融業界に興味があり、人と協力しながら成長したいと考えています。'),
((SELECT id FROM users WHERE email = 'hashimoto.hitomi@example.com'), '読書, ボードゲーム, カフェ', '東京都', '法人', 'INTP', '早稲田大学', 'hobbies', '橋本瞳です！読書やボードゲームが好きで、カフェでゆっくり過ごすのが楽しみです。法人分野で働き、ビジネスに関する知識を深めていきたいです。'),
((SELECT id FROM users WHERE email = 'honda.yuko@example.com'), 'サッカー, ラーメン, 旅行', '千葉県', '法人', 'ENTP', '東京大学', 'field', '本田裕子です！サッカーやラーメンが大好きで、旅行にもよく行きます。法人分野で活躍し、より多くのチャンスに挑戦したいと考えています。'),
...
((SELECT id FROM users WHERE email = 'kato.rina@example.com'), 'カメラ, 旅行, プログラミング', '大阪府', '技統本', 'INTP', '慶應義塾大学', 'alma_mater', '加藤里奈です！カメラと旅行が趣味で、プログラミングにも取り組んでいます。技術分野で新しい挑戦を求めており、問題解決能力を伸ばしていきたいです。'),
((SELECT id FROM users WHERE email = 'oshima.hiroki@example.com'), 'スポーツ観戦, 音楽, キャンプ', '福岡県', '法人', 'ISFJ', '北海道大学', 'hobbies', '大島博樹です！スポーツ観戦と音楽が大好きで、キャンプもよく楽しんでいます。法人分野で活躍し、チームワークを大切にしたいと考えています。'),
((SELECT id FROM users WHERE email = 'sano.miho@example.com'), '読書, バスケットボール, ダンス', '神奈川県', '公共', 'ISFP', '東京大学', 'field', '佐野美穂です！読書とバスケットボールが趣味で、ダンスも楽しんでいます。公共分野で人々に貢献できる仕事をしたいと考えています。'),
((SELECT id FROM users WHERE email = 'kimura.katsuhiko@example.com'), '映画鑑賞, ボードゲーム, 音楽', '大阪府', '法人', 'ENTP', '立命館大学', 'hobbies', '木村勝彦です！映画鑑賞と音楽が好きで、ボードゲームも友達と楽しんでいます。法人分野で新しいチャレンジをして、ビジネススキルを高めたいと考えています。'),
((SELECT id FROM users WHERE email = 'inoue.daisuke@example.com'), 'サッカー, 音楽, プログラミング', '東京都', '技統本', 'ESTP', '早稲田大学', 'hobbies, mbti', '井上大輔です！サッカーと音楽が大好きで、プログラミングにも興味があります。技術的な問題解決に挑戦し、スキルを高めていきたいです。'),
((SELECT id FROM users WHERE email = 'nagata.nana@example.com'), 'ダンス, サッカー, 旅行', '愛知県', '金融', 'INFJ', '名古屋大学', 'role', '永田奈々です！ダンスやサッカーが好きで、旅行にもよく行きます。金融業界で、人と関わりながら成長したいと思っています。'),
((SELECT id FROM users WHERE email = 'matsui.yuka@example.com'), 'カメラ, 料理, 旅行', '東京都', '法人', 'ESFJ', '慶應義塾大学', 'hobbies', '松井優香です！カメラと料理が趣味で、旅行を通じて世界を広げています。法人分野でのキャリアを築き、人々に貢献する仕事をしたいです。'),
((SELECT id FROM users WHERE email = 'takayama.eri@example.com'), '音楽, 映画鑑賞, ボードゲーム', '神奈川県', '技統本', 'INTJ', '東京大学', 'hobbies', '高山恵理です！音楽と映画鑑賞が好きで、ボードゲームを友達とよくします。技術の分野で問題解決を行い、革新的なアイデアを形にしていきたいです。'),
((SELECT id FROM users WHERE email = 'suzuki.masaki1@example.com'), '料理, バスケットボール, 音楽', '大阪府', '法人', 'ENTJ', '立命館大学', 'field', '鈴木昌樹です！料理やバスケットボールが好きで、音楽を聴くことが日課です。法人分野で戦略的な思考を活かし、リーダーシップを発揮したいと考えています。'),
...
((SELECT id FROM users WHERE email = 'harada.sho@example.com'), 'プログラミング, 映画鑑賞, バスケットボール', '大阪府', '技統本', 'ENTP', '東京大学', 'hobbies, field', '原田翔です！プログラミングと映画鑑賞が趣味で、バスケットボールを楽しんでいます。技術分野で成長し、社会に貢献できる仕事をしたいです。'),
((SELECT id FROM users WHERE email = 'kato.tomoko@example.com'), '読書, 料理, ボードゲーム', '東京都', '法人', 'ISTP', '名古屋大学', 'role, hobbies', '加藤智子です！読書と料理が趣味で、ボードゲームも楽しんでいます。法人分野で仕事を学び、成長したいと考えています。'),
