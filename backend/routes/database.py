...
('大島 結衣', 'oshima.yui@example.com', 'U34567891', crypt('securepassword14', gen_salt('bf')), '2023-05-14'),
('松本 裕樹', 'matsumoto.yuki@example.com', 'U45678902', crypt('securepassword15', gen_salt('bf')), '2023-05-15'),
('藤田 千夏', 'fujita.chinatsu@example.com', 'U56789023', crypt('securepassword16', gen_salt('bf')), '2023-05-16'),
('渡辺 大輝', 'watanabe.daiki@example.com', 'U67890134', crypt('securepassword17', gen_salt('bf')), '2023-05-17'),
('石井 彩花', 'ishii.ayaka@example.com', 'U78901245', crypt('securepassword18', gen_salt('bf')), '2023-05-18'),
('清水 優太', 'shimizu.yuta@example.com', 'U89012356', crypt('securepassword19', gen_salt('bf')), '2023-05-19'),
('長谷川 結衣', 'hasegawa.yui@example.com', 'U90123467', crypt('securepassword20', gen_salt('bf')), '2023-05-20'),
...
('坂井 大志', 'sakai.taishi@example.com', 'U01234571', crypt('securepassword31', gen_salt('bf')), '2023-06-10'),
('平田 真紀', 'hirata.maki@example.com', 'U12345682', crypt('securepassword32', gen_salt('bf')), '2023-06-11'),
('中田 健太', 'nakata.kenta@example.com', 'U23456793', crypt('securepassword33', gen_salt('bf')), '2023-06-12'),
('加藤 美月', 'kato.mizuki@example.com', 'U34567894', crypt('securepassword34', gen_salt('bf')), '2023-06-13'),
('佐々木 明日香', 'sasaki.asuka@example.com', 'U45678904', crypt('securepassword35', gen_salt('bf')), '2023-06-14'),
('中村 翼', 'nakamura.tsubasa@example.com', 'U56789035', crypt('securepassword36', gen_salt('bf')), '2023-06-15'),
('藤田 翼', 'fujita.tsubasa@example.com', 'U67890156', crypt('securepassword37', gen_salt('bf')), '2023-06-16'),
('坂本 愛', 'sakamoto.ai@example.com', 'U78901267', crypt('securepassword38', gen_salt('bf')), '2023-06-17'),
('原田 大輝', 'harada.daiki@example.com', 'U89012378', crypt('securepassword39', gen_salt('bf')), '2023-06-18'),
('吉岡 千晶', 'yoshioka.chiaki@example.com', 'U90123489', crypt('securepassword40', gen_salt('bf')), '2023-06-19'),
('林 大地', 'hayashi.daichi@example.com', 'U01234570', crypt('securepassword41', gen_salt('bf')), '2023-06-20'),
('小川 茉莉', 'ogawa.mari@example.com', 'U12345681', crypt('securepassword42', gen_salt('bf')), '2023-06-21'),
('木村 崇', 'kimura.takashi@example.com', 'U23456792', crypt('securepassword43', gen_salt('bf')), '2023-06-22'),
('加藤 美月', 'kato.mizuki@example.com', 'U34567893', crypt('securepassword44', gen_salt('bf')), '2023-06-23'),
('佐々木 明日香', 'sasaki.asuka@example.com', 'U45678904', crypt('securepassword45', gen_salt('bf')), '2023-06-24'),
('中村 翼', 'nakamura.tsubasa@example.com', 'U56789035', crypt('securepassword46', gen_salt('bf')), '2023-06-25'),
('藤田 翼', 'fujita.tsubasa@example.com', 'U67890156', crypt('securepassword47', gen_salt('bf')), '2023-06-26'),
('坂本 愛', 'sakamoto.ai@example.com', 'U78901267', crypt('securepassword48', gen_salt('bf')), '2023-06-27'),
('原田 大輝', 'harada.daiki@example.com', 'U89012378', crypt('securepassword49', gen_salt('bf')), '2023-06-28'),
('吉岡 千晶', 'yoshioka.chiaki@example.com', 'U90123489', crypt('securepassword50', gen_salt('bf')), '2023-06-29'),
...
('加藤 美月', 'kato.mizuki@example.com', 'U34567893', crypt('securepassword54', gen_salt('bf')), '2023-06-23'),
('佐々木 明日香', 'sasaki.asuka@example.com', 'U45678904', crypt('securepassword55', gen_salt('bf')), '2023-06-24'),
('中村 翼', 'nakamura.tsubasa@example.com', 'U56789035', crypt('securepassword56', gen_salt('bf')), '2023-06-25'),
('藤田 翼', 'fujita.tsubasa@example.com', 'U67890156', crypt('securepassword57', gen_salt('bf')), '2023-06-26'),
('坂本 愛', 'sakamoto.ai@example.com', 'U78901267', crypt('securepassword58', gen_salt('bf')), '2023-06-27'),
('原田 大輝', 'harada.daiki@example.com', 'U89012378', crypt('securepassword59', gen_salt('bf')), '2023-06-28'),
('吉岡 千晶', 'yoshioka.chiaki@example.com', 'U90123489', crypt('securepassword60', gen_salt('bf')), '2023-06-29'),
...
('中村 優太', 'nakamura.yuta@example.com', 'U90123494', crypt('securepassword100', gen_salt('bf')), '2023-08-08');
"""
