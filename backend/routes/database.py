...
('鈴木 一郎', 'suzuki.ichiro@example.com', 'U11111111', 'securepassword1', NULL, '2023-03-01'),
('高橋 美咲', 'takahashi.misaki@example.com', 'U22222222', 'securepassword2', NULL, '2023-03-02'),
('佐藤 大輔', 'sato.daisuke@example.com', 'U33333333', 'securepassword3', NULL, '2023-03-03'),
('田中 直樹', 'tanaka.naoki@example.com', 'U44444444', 'securepassword4', NULL, '2023-03-04'),
('中村 由美', 'nakamura.yumi@example.com', 'U55555555', 'securepassword5', NULL, '2023-03-05'),
('山本 翔太', 'yamamoto.shota@example.com', 'U66666666', 'securepassword6', NULL, '2023-03-06'),
('小林 仁美', 'kobayashi.hitomi@example.com', 'U77777777', 'securepassword7', NULL, '2023-03-07'),
('加藤 健太', 'kato.kenta@example.com', 'U88888888', 'securepassword8', NULL, '2023-03-08'),
('松本 綾子', 'matsumoto.ayako@example.com', 'U99999999', 'securepassword9', NULL, '2023-03-09'),
('石井 佳子', 'ishii.keiko@example.com', 'U10101010', 'securepassword10', NULL, '2023-03-10'),
('岡田 翔太', 'okada.shota@example.com', 'U11121314', 'securepassword11', NULL, '2023-03-11'),
('吉田 美由紀', 'yoshida.miyuki@example.com', 'U22232425', 'securepassword12', NULL, '2023-03-12'),
('井上 雄一', 'inoue.yuichi@example.com', 'U33343536', 'securepassword13', NULL, '2023-03-13'),
('橋本 真由美', 'hashimoto.mayumi@example.com', 'U44454647', 'securepassword14', NULL, '2023-03-14'),
('山田 俊輔', 'yamada.shunsuke@example.com', 'U55565758', 'securepassword15', NULL, '2023-03-15'),
('藤田 玲奈', 'fujita.reina@example.com', 'U66676869', 'securepassword16', NULL, '2023-03-16'),
('松田 悠介', 'matsuda.yusuke@example.com', 'U77787980', 'securepassword17', NULL, '2023-03-17'),
('黒田 由香', 'kuroda.yuka@example.com', 'U88899091', 'securepassword18', NULL, '2023-03-18'),
('小松 美奈子', 'komatsu.minako@example.com', 'U99910102', 'securepassword19', NULL, '2023-03-19'),
('三浦 正博', 'miura.masahiro@example.com', 'U10111213', 'securepassword20', NULL, '2023-03-20'),
('田村 宗一郎', 'tamura.souichiro@example.com', 'U11121415', 'securepassword21', NULL, '2023-03-21'),
('遠藤 愛子', 'endo.aiko@example.com', 'U22232526', 'securepassword22', NULL, '2023-03-22'),
('小野 芳樹', 'ono.yoshiki@example.com', 'U33343637', 'securepassword23', NULL, '2023-03-23'),
('西村 雅彦', 'nishimura.masahiko@example.com', 'U44454748', 'securepassword24', NULL, '2023-03-24'),
('高田 美月', 'takada.mizuki@example.com', 'U55565859', 'securepassword25', NULL, '2023-03-25'),
('岩崎 真治', 'iwasaki.shinji@example.com', 'U66676970', 'securepassword26', NULL, '2023-03-26'),
('村上 加奈子', 'murakami.kanako@example.com', 'U77788081', 'securepassword27', NULL, '2023-03-27'),
('原田 結衣', 'harada.yui@example.com', 'U88899102', 'securepassword28', NULL, '2023-03-28'),
('木村 渚', 'kimura.nagisa@example.com', 'U99910203', 'securepassword29', NULL, '2023-03-29'),
('藤原 理恵', 'fujiwara.rie@example.com', 'U10121314', 'securepassword30', NULL, '2023-03-30'),
('佐々木 啓太', 'sasaki.keita@example.com', 'U11121315', 'securepassword31', NULL, '2023-03-31'),
('宮崎 寿美子', 'miyazaki.sumiko@example.com', 'U22232427', 'securepassword32', NULL, '2023-04-01'),
('林 哲也', 'hayashi.tetsuya@example.com', 'U33343639', 'securepassword33', NULL, '2023-04-02'),
('小川 彩花', 'ogawa.ayaka@example.com', 'U44454750', 'securepassword34', NULL, '2023-04-03'),
('村田 由紀', 'murata.yuki@example.com', 'U55565861', 'securepassword35', NULL, '2023-04-04'),
('高木 美沙子', 'takagi.misako@example.com', 'U66676972', 'securepassword36', NULL, '2023-04-05'),
('石田 健一', 'ishida.kenichi@example.com', 'U77788083', 'securepassword37', NULL, '2023-04-06'),
('坂本 涼', 'sakamoto.ryo@example.com', 'U88899104', 'securepassword38', NULL, '2023-04-07'),
('金子 美咲', 'kaneko.misaki@example.com', 'U99910206', 'securepassword39', NULL, '2023-04-08'),
('渡辺 順子', 'watanabe.junko@example.com', 'U10121316', 'securepassword40', NULL, '2023-04-09'),
('木下 陽子', 'kinoshita.youko@example.com', 'U11121317', 'securepassword41', NULL, '2023-04-10'),
('森本 誠', 'morimoto.makoto@example.com', 'U22232429', 'securepassword42', NULL, '2023-04-11'),
('斉藤 聡', 'saito.satoshi@example.com', 'U33343641', 'securepassword43', NULL, '2023-04-12'),
('藤井 朋子', 'fujii.tomoko@example.com', 'U44454752', 'securepassword44', NULL, '2023-04-13'),
('高橋 直人', 'takahashi.naoto@example.com', 'U55565863', 'securepassword45', NULL, '2023-04-14'),
('長谷川 佳奈', 'hasegawa.kenna@example.com', 'U66676974', 'securepassword46', NULL, '2023-04-15'),
('吉村 亮', 'yoshimura.ryo@example.com', 'U77788085', 'securepassword47', NULL, '2023-04-16'),
('中川 佐代', 'nakagawa.sayo@example.com', 'U88899106', 'securepassword48', NULL, '2023-04-17'),
('橋本 瞳', 'hashimoto.hitomi@example.com', 'U99910208', 'securepassword49', NULL, '2023-04-18'),
('本田 裕子', 'honda.yuko@example.com', 'U10121318', 'securepassword50', NULL, '2023-04-19'),
('坂口 優希', 'sakaguchi.yuki@example.com', 'U11121319', 'securepassword51', NULL, '2023-04-20'),
('加藤 里奈', 'kato.rina@example.com', 'U22232431', 'securepassword52', NULL, '2023-04-21'),
('大島 博樹', 'oshima.hiroki@example.com', 'U33343643', 'securepassword53', NULL, '2023-04-22'),
('佐野 美穂', 'sano.miho@example.com', 'U44454754', 'securepassword54', NULL, '2023-04-23'),
('木村 勝彦', 'kimura.katsuhiko@example.com', 'U55565865', 'securepassword55', NULL, '2023-04-24'),
('井上 大輔', 'inoue.daisuke@example.com', 'U66676976', 'securepassword56', NULL, '2023-04-25'),
('永田 奈々', 'nagata.nana@example.com', 'U77788087', 'securepassword57', NULL, '2023-04-26'),
('松井 優香', 'matsui.yuka@example.com', 'U88899108', 'securepassword58', NULL, '2023-04-27'),
('高山 恵理', 'takayama.eri@example.com', 'U99910210', 'securepassword59', NULL, '2023-04-28'),
('鈴木 昌樹', 'suzuki.masaki1@example.com', 'U10121320', 'securepassword60', NULL, '2023-04-29'),
('井口 聡子', 'iguchi.satoko@example.com', 'U11121321', 'securepassword61', NULL, '2023-04-30'),
('原田 翔', 'harada.sho@example.com', 'U22232433', 'securepassword62', NULL, '2023-05-01'),
('加藤 智子', 'kato.tomoko@example.com', 'U33343645', 'securepassword63', NULL, '2023-05-02'),
('渡辺 尚子', 'watanabe.naoko@example.com', 'U44454756', 'securepassword64', NULL, '2023-05-03'),
('佐々木 愛', 'sasaki.ai@example.com', 'U55565867', 'securepassword65', NULL, '2023-05-04'),
('野村 亮介', 'nomura.ryosuke@example.com', 'U66676978', 'securepassword66', NULL, '2023-05-05'),
('今井 和也', 'imai.kazuya@example.com', 'U77788089', 'securepassword67', NULL, '2023-05-06'),
('島田 裕子', 'shimada.yuko@example.com', 'U88899110', 'securepassword68', NULL, '2023-05-07'),
('小川 優斗', 'ogawa.yuto@example.com', 'U99910212', 'securepassword69', NULL, '2023-05-08'),
('加藤 裕子', 'kato.hiroko@example.com', 'U10121322', 'securepassword70', NULL, '2023-05-09'),
('山下 亜美', 'yamashita.ami@example.com', 'U11121323', 'securepassword71', NULL, '2023-05-10'),
('松本 卓也', 'matsumoto.takuya@example.com', 'U22232435', 'securepassword72', NULL, '2023-05-11'),
('村田 秀一', 'murata.shuichi@example.com', 'U33343647', 'securepassword73', NULL, '2023-05-12'),
('高木 亜紀', 'takagi.aki@example.com', 'U44454758', 'securepassword74', NULL, '2023-05-13'),
('福田 芳子', 'fukuda.yoshiko@example.com', 'U55565870', 'securepassword75', NULL, '2023-05-14'),
('吉田 和也', 'yoshida.kazuya@example.com', 'U66676980', 'securepassword76', NULL, '2023-05-15'),
('佐藤 玲', 'sato.rei@example.com', 'U77788091', 'securepassword77', NULL, '2023-05-16'),
('加藤 美樹', 'kato.miki@example.com', 'U88899112', 'securepassword78', NULL, '2023-05-17'),
('石井 健', 'ishii.ken@example.com', 'U99910214', 'securepassword79', NULL, '2023-05-18'),
('小林 里奈', 'kobayashi.rina@example.com', 'U10121324', 'securepassword80', NULL, '2023-05-19'),
('田中 友香', 'tanaka.tomoka@example.com', 'U11121326', 'securepassword81', NULL, '2023-05-20'),
('川口 賢治', 'kawaguchi.kenji@example.com', 'U22232438', 'securepassword82', NULL, '2023-05-21'),
('田村 華子', 'tamura.hanako@example.com', 'U33343649', 'securepassword83', NULL, '2023-05-22'),
('鈴木 正樹', 'suzuki.masaki@example.com', 'U44454760', 'securepassword84', NULL, '2023-05-23'),
('山本 志保', 'yamamoto.shiho@example.com', 'U55565872', 'securepassword85', NULL, '2023-05-24'),
('松田 悠人', 'matsuda.yuto@example.com', 'U66676983', 'securepassword86', NULL, '2023-05-25'),
('斉藤 一樹', 'saito.kazuki@example.com', 'U77788094', 'securepassword87', NULL, '2023-05-26'),
('三浦 薫', 'miura.kaoru@example.com', 'U88899116', 'securepassword88', NULL, '2023-05-27'),
('木村 由香', 'kimura.yuka@example.com', 'U99910218', 'securepassword89', NULL, '2023-05-28'),
('高橋 俊介', 'takahashi.shunsuke@example.com', 'U10121328', 'securepassword90', NULL, '2023-05-29'),
('西村 浩二', 'nishimura.koji@example.com', 'U11121330', 'securepassword91', NULL, '2023-05-30'),
('田村 浩子', 'tamura.hiroko@example.com', 'U22232440', 'securepassword92', NULL, '2023-05-31'),
('小林 結衣', 'kobayashi.yui@example.com', 'U33343651', 'securepassword93', NULL, '2023-06-01'),
('松本 信也', 'matsumoto.shinya@example.com', 'U44454762', 'securepassword94', NULL, '2023-06-02'),
('池田 美咲', 'ikeda.misaki@example.com', 'U55565874', 'securepassword95', NULL, '2023-06-03'),
('木下 知幸', 'kinoshita.tomoyuki@example.com', 'U66676985', 'securepassword96', NULL, '2023-06-04'),
('田中 実', 'tanaka.minoru@example.com', 'U77788096', 'securepassword97', NULL, '2023-06-05'),
('永井 優', 'nagai.yu@example.com', 'U88899118', 'securepassword98', NULL, '2023-06-06'),
('川口 美穂', 'kawaguchi.miho@example.com', 'U99910220', 'securepassword99', NULL, '2023-06-07'),
('石井 哲也', 'ishii.tetsuya@example.com', 'U10121332', 'securepassword100', NULL, '2023-06-08');
"""
...
((SELECT id FROM users WHERE email = 'ishida.kenichi@example.com'), 'サッカー, 旅行, プログラミング', '福岡県', '技統本', 'SE', 'ENTJ', '東京大学', 'hobbies', '石田健一です！サッカーや旅行が好きで、プログラミングに興味があります。技術分野でリーダーシップを発揮し、組織を導く役割を担いたいと思っています。'),
((SELECT id FROM users WHERE email = 'sakamoto.ryo@example.com'), '料理, 音楽, キャンプ', '北海道', '金融', 'SE', 'INTP', '北海道大学', 'field', '坂本涼です！料理や音楽が趣味で、キャンプも楽しんでいます。金融業界における新たな挑戦を求めており、理論的かつ戦略的に取り組みたいです。'),
((SELECT id FROM users WHERE email = 'kaneko.misaki@example.com'), '旅行, サッカー, 釣り', '東京都', '法人', '営業', 'ISTP', '慶應義塾大学', 'role', '金子美咲です！旅行とサッカーが大好きで、釣りも趣味の一つです。法人分野でチームを率いてプロジェクトを成功させることに興味があります。'),
((SELECT id FROM users WHERE email = 'watanabe.junko@example.com'), '映画鑑賞, ダンス, 読書', '神奈川県', '公共', '営業', 'ESFJ', '立命館大学', 'hobbies', '渡辺順子です！映画鑑賞とダンスが趣味で、読書も楽しんでいます。社会的な貢献を目指して公共の分野で成長したいと思っています。'),
